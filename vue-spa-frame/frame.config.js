...
module.exports = {
  ...
  cdnMap: {
    ...
    outsideJs: [
      ...
      {
        path:
          'https://cdn.bootcdn.net/ajax/libs/html2canvas/0.4.1/html2canvas.min.js',
        async: true,
        defer: true
      },
      {
      ...
      {
        path: 'https://a.amap.com/Loca/static/mock/adcodes.js' // 高德行政区域
      },
      {
        path: 'https://a.amap.com/jsapi_demos/static/citys.js' // 海量点数据接口
      },
      {
        path: '/static/plugins/china/china.js' // 高德地图聚合点-数据接口
      }
    ],
    outsideCss: [
