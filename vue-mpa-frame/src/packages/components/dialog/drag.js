...
// 拖拽指令
import vDragDialog from './el-drag-dialog/index.js';
/**
...
const BaseDragDialog = function(options = {}) {
  const that = this;
    ...
    render(h) {
      ...
      return h(
        'el-dialog',
        {
          ...
          props: _assign(
            {
              // destroyOnClose: true, // 设置为 true 会在拖动弹框点击关闭时重置到初始的位置，所以注释了，如果想销毁组件请设置 isDestroy: true
              title: '详情',
