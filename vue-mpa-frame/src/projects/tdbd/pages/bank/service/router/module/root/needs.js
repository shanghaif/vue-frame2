...
const index = [
  {
    ...
    component: () =>
      import(
        /* webpackChunkName:"bank/views/needs/index" */ '@bank_views/needs/index.vue'
      ),
    children: [
      {
        path: 'loan',
        ...
        component: () =>
          import(
            /* webpackChunkName:"bank/views/needs/load" */ '@bank_views/needs/loan.vue'
          ),
        children: [
          // {
          //   name: 'record',
          ...
          // },
          {
            ...
            component: () =>
              import(
                /* webpackChunkName:"bank/views/needs/assess" */ '@bank_views/needs/assess.vue'
              )
          }
        ]
      }
