<template>
  <base-double-wing class="top-view">
    ...
    <template v-slot:right>
      <div :class="[{'full-y': true}, {'right-box': true}, {'flex-center': true}]">
        <div>
        ...
        <div @click="onClickFullScreen" title="全屏" :class="{pointer: true}">
...
export default {
  ...
  data() {
    return {
      ...
      isFullscreen: false,
      options: [
        { text: '个人中心', icon: 'el-icon-user', listeners: { click: this.onOpenPersonal } },
