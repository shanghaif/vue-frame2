...
module.exports = {
  // 网站名称
  sys_app_title: '浙江省小微园区管理SAAS子平台', // 网站名称，html 的 title 标签
  ...
  cdnMap: {
    ...
    outsideJs: [],
    outsideCss: [
      '/static/css-lib-theme/common/font/iconfont/iconfont.css'
    ],
