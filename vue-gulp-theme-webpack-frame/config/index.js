...
module.exports = {
  dev: {
    ...
    cssLibThemeSubDirectory: 'static/css-lib-theme', // css 主体库-静态文件目录（编译后），CopyWebpackPlugin
    cssThemeSubDirectory: 'static/css-theme', // css 主体库-静态文件目录（静态资源-图片等），CopyWebpackPlugin
    /**
    ...
    // 服务器代理设置
    writeToDisk: false, // devServer 将产生的文件写入硬盘。 写入位置为 output.path 配置的目录
  ...
  build: {
    ...
    cssLibThemeSubDirectory: 'static/css-lib-theme', // css 主体库-静态文件目录，CopyWebpackPlugin
    cssThemeSubDirectory: 'static/css-theme', // css 主体库-静态文件目录（静态资源-图片等），CopyWebpackPlugin
